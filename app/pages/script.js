...
async function cadastroLogin() {
    ...
    fetch('http://187.95.26.193:3333/login', {
        method: 'POST',
        headers: {
...
async function realizarLogin(event) {
  ...
  const response = await fetch('http://187.95.26.193:3333/login/validacao', {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
      },
...
async function verificarCPFExistente(CPF) {
    const response = await fetch(`http://187.95.26.193:3333/clientes/${CPF}`);
    const data = await response.json();
    return data.existe;
}
...
async function enviarCadastroCliente() {
    ...
    // Enviar dados para o backend usando fetch
    fetch('http://187.95.26.193:3333/clientes', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function buscarClientes() { 
    try {
        const tenant = userInfo.id_tenant;
        const resposta = await fetch(`http://187.95.26.193:3333/clientes/${tenant}`);
...
async function updateCadastroCliente() {
    ...
    // Enviar dados para o backend usando fetch
    fetch(`http://187.95.26.193:3333/clientes/${id_cliente}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function gerarDocumento() {
    ...
    const response = await fetch('http://187.95.26.193:3333/gerar-docx', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
