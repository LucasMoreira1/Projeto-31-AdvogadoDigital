const produtoButton = document.getElementById("produto-button");
const produtoDiv = document.getElementById("produto-div");
let isDivVisible = false;

produtoButton.addEventListener("click", () => {
  produtoButton.classList.add("text-red-600");
  if (isDivVisible) {
    produtoDiv.classList.add("hidden");
    produtoButton.classList.remove("text-red-600");
  } else {
...
//
//FlowBiteJS abaixo: https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.8.1/flowbite.min.js
//
